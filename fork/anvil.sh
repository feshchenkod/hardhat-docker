...
--name $NAME anvil-node timeout $TIMEOUT anvil --allow-origin=* --host 0.0.0.0 -f $DEFAULT_RPC $HEIGHT $INTERVAL $CACHE --block-base-fee-per-gas 1000000000 --gas-limit 50000000 \
1> /dev/null
